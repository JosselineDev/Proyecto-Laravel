...
use App\Models\DocenteGrupo;//Importa el modelo DocenteGrupo.
use Illuminate\Http\Request;

use App\Models\Docente;
use App\Models\Grupo;

class DocenteGrupoController extends Controller//Esta clase hereda de Controller, lo que le da acceso a funcionalidades básicas de un controlador en Laravel.
{
    /**
